"""
Motor v3: generaliza select_trades para permitir tocar tambien los
parametros de DETECCION de order blocks (no solo TP/BE), usado para
buscar una configuracion rentable especificamente para la sesion
nocturna (18:00-00:00 NY), a pedido del usuario.

Todos los defaults son identicos a engine2.py (que sigue siendo la
referencia validada) -- este archivo es una generalizacion, no un motor
distinto.
"""
import json, os
...
def select_trades(bars, rr1=1.8, rr2=5.0, be_trigger_r=1.2, lock_r=1.0, cooldown_bars=0,
