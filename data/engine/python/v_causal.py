...
def sel_causal(bars, entry_mode='aire', rr1=1.8, rr2=5.0, be_trigger_r=1.2, lock_r=1.0, cooldown_bars=0,
    ...
    for i in range(n):
        ...
        for z in zones:
            if z.born != i and not z.cleared:
                if z.dir == 1 and l > z.top: z.cleared = True; z.cleared_bar = i
                elif z.dir == -1 and h < z.bot: z.cleared = True; z.cleared_bar = i
        ...
        if can_enter:
            ...
            for z in zones:
                ...
                if i <= z.cleared_bar: continue     # la orden aun no podia estar puesta
