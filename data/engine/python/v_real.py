...
def sel_real(bars, rr1=1.8, rr2=5.0, be_trigger_r=1.2, lock_r=1.0, cooldown_bars=0,
    ...
    for i in range(n):
        ...
        if can_enter:
            ...
            for z in _elegibles:
                if z.born == i or not z.cleared: continue
                if (i - z.born) > zone_max_age: continue
                if z.dir == 1 and l <= z.top + entry_buffer_pts:
                    ...
                    if r > 0 and (not use_risk_cap or r <= max_risk_pts):
                        if z.born > cand_born:
                            ...
                            cand_zone = z
                if z.dir == -1 and h >= z.bot - entry_buffer_pts:
