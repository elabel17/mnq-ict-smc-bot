...
def sel_split(bars, rr1=1.8, rr2=5.0, be_trigger_r=1.2, lock_r=1.0, cooldown_bars=0,
    ...
    for i in range(n):
        ...
        if can_enter:
            ...
            for z in zones:
                ...
                _lv = (z.top + entry_buffer_pts) if z.dir == 1 else (z.bot - entry_buffer_pts)
        ...
        if can_enter and cand_dir != 0:
            ...
            cur_ob_lvl = cand_zone.top if cand_dir == 1 else cand_zone.bot
            cur_penetro = (l <= cand_zone.top) if cand_dir == 1 else (h >= cand_zone.bot)
            ...
            if entry_buffer_pts > 0:
                ...
                buf_depth = 0.0
            cur_trade = {"ob_lvl": cur_ob_lvl, "penetro": cur_penetro,"entry_bar": i, "entry_time": t, "dir": dir_,
